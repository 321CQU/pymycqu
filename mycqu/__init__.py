from . import auth, course, exam, mycqu, score, card, exception, library, enroll
from .auth import *
from .course import *
from .exam import *
from .score import *
...
__all__ = ["auth", "course", "exam", "mycqu", "score", "card", "library", "enroll"]
